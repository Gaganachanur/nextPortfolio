    ...
    <Fragment>
      ...
      <div className="flex flex-wrap justify-around ">
        <div className="dark:text-white text-xl py-2 leading-8 ">
          ...
          <h3>
            - Stripe as Payment gateway feel free to checkout your fav Dress :)
          </h3>
        </div>
        <div
          onClick={() => window.open(fashionUrl)}
          className="border-spacing-4 cursor-pointer dark:text-black
       dark:bg-gray-100 shadow-md hover:shadow-2xl p-10 m-5 rounded-xl
       dark:ring-offset-slate-900 ... transform transition-all hover:scale-110 ease-in-out duration-500"
        >
          <Image src={fashionimg} height={300} width={700} />
        </div>
      </div>
    </Fragment>
  );
