...
export const ContactUs = () => {
  ...
  return (
    ...
    <div className='flex flex-wrap justify-center py-3'>
      ...
      <input className='border-4 py-1 lg:px-10  px-5 m-3 rounded-full' required type="text" name="to_name" />
      <label className='px-3'>Email</label>
      <input  className='border-4 py-1 lg:px-10 px-5  m-3 rounded-full' required type="email" name="from_name" />
    </div>
    <div className='flex flex-wrap justify-center py-3'>
